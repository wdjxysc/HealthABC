...
@property (weak, nonatomic) IBOutlet RC_ProgressView *myRC_ProgressView;
...
-(void)initMyView
{
    _myRC_ProgressView.backgroundColor = [UIColor colorWithRed:190/255.0f green:190/255.0f blue:190/255.0f alpha:1.0];
    [_myRC_ProgressView setMainColor:[UIColor colorWithRed:117/255.0f green:221/255.0f blue:236/255.0f alpha:1.0]];
...
- (void)peripheral:(CBPeripheral *)peripheral didUpdateValueForCharacteristic:(CBCharacteristic *)characteristic error:(NSError *)error
{
    ...
    if([lol length]==2)
    {
        ...
        [_myRC_ProgressView setProgressValue:revdata[1]/256.0f];
    }
...
//            [alert show];
        ...
        [myThread2 start];
        //显示血压进度条
        [_myRC_ProgressView setProgressValue:sysdata/256.0f];
