...
- (id)initWithNibName:(NSString *)nibNameOrNil bundle:(NSBundle *)nibBundleOrNil
{
    ...
    if (self) {
        ...
        if([MySingleton sharedSingleton].isLogined == YES){
...
-(void)initMyView
{
    ...
    heightTextField.text = [[NSString alloc]initWithFormat:@"%@(cm)",[[MySingleton sharedSingleton].nowuserinfo valueForKey:@"Height"]];
